{{-- filepath: /home/rajadwiaqso/Desktop/market 4.0/resources/views/seller/chat.blade.php --}}
@extends('layout')
...
@section('konten')
    <div class="container py-5">
        ...
        <!-- Chat Form -->
        <form class="message-form mt-3" action="{{ route('seller.chat.send') }}" method="post">
            @csrf
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMessageToChat(messageData, isLocal = false) {
        ...
        if (!existingMessage) {
            ...
            messageBox.classList.add('message-box', messageData.sender === currentUserRole ? 'seller' : 'buyer');
